		...
		<ScrollView contentContainerStyle={styles.scrollViewContent}>
			<View style={styles.cardContainer}>
				<View style={styles.row}>
					<Link href="/screens/category/kpop" asChild>
					...
					<Link href="/screens/category/shortform" asChild>
						<TouchableOpacity style={styles.card}>
							<View style={styles.cardBackground}>
								<Image
				...
				<View style={styles.row}>
					<Link href="/screens/category/trot" asChild>
						<TouchableOpacity style={styles.card}>
							<View style={styles.cardBackground}>
								<Image
					...
					<Link href="/screens/category/create" asChild>
						<TouchableOpacity style={styles.card}>
							<View style={styles.cardBackground}>
								<Image
